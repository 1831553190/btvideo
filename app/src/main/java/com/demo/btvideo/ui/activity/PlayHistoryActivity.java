...
public class PlayHistoryActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        emptyMsg.setText("无播放记录");
        baseTitle.setText("播放记录");
        ...
        new DataLoaderViewModel().getPlayHistory(this).observe(this, commentPagingData -> uploadAdapter.submitData(getLifecycle(),commentPagingData));
        ...
        uploadAdapter.setOnItemClickListener(new UploadAdapter.OnItemClick() {
            ...
            public void onItemClick(View view, VideoInfo videoInfo, int pos) {
                Intent intent=new Intent(PlayHistoryActivity.this, VideoDetialsActivity.class);
