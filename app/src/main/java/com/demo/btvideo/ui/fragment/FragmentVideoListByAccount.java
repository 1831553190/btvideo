...
//作品页面
public class FragmentVideoListByAccount extends Fragment {
	...
	private static class Holder {
		private static FragmentVideoListByAccount instance = new FragmentVideoListByAccount();
	}

	public static FragmentVideoListByAccount getInstance() {
		return FragmentVideoListByAccount.Holder.instance;
	}
...
//				if (pair.second==2){
					dataLoaderViewModel.getUploadVideo(pair.first).removeObservers(getViewLifecycleOwner());
					dataLoaderViewModel.getUploadVideo(pair.first).observe(getViewLifecycleOwner(), collectionPagingData -> {
