...
public class PlayerManager {
    ...
    private GiraffePlayer createPlayer(VideoView videoView) {
        ...
        registerActivityLifecycleCallbacks((scanForActivity( videoView.getContext())).getApplication());
        ...
        if (topActivityRef == null || topActivityRef.get() == null) {
            topActivityRef = new WeakReference<>(scanForActivity(videoView.getContext()));
        }
        return player;
    }
